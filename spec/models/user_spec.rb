...
RSpec.describe User, type: :model do
  describe 'ユーザー新規登録' do
    ...
    it "passwordが半角英数字混合でない場合登録できない" do
      user = User.new(nickname: "Taro", email: "abcdefgh@gmail.com", password: "1896757", password_confirmation: "1896757", last_name: "遠藤", first_name: "太郎", last_name_kana: "エンドウ", first_name_kana: "タロウ", birthday: "1990-01-01")
      user.valid?
    ...
    it "last_nameが空だと登録できない" do
      user = User.new(nickname: "Taro", email: "abcdefgh@gmail.com", password: "12345abcdef", password_confirmation: "12345abcdef", last_name: "", first_name: "太郎", last_name_kana: "エンドウ", first_name_kana: "タロウ", birthday: "1990-01-01")
      user.valid?
      expect(user.errors.full_messages).to include("Last name can't be blank")
    end
    it "first_nameが空だと登録できない" do
      user = User.new(nickname: "Taro", email: "abcdefgh@gmail.com", password: "12345abcdef", password_confirmation: "12345abcdef", last_name: "遠藤", first_name: "", last_name_kana: "エンドウ", first_name_kana: "タロウ", birthday: "1990-01-01")
      user.valid?
